...
async function handlerPostPrediction(request, h) {
...
const handlerPredictionHistories = async (request, h) => {
...
module.exports = { handlerPredictionHistories, handlerPostPrediction};